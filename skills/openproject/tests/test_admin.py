...
from openproject_admin import get_configuration
from openproject_admin import list_types, get_type, list_project_types
from openproject_admin import list_statuses, get_status, list_open_statuses, list_closed_statuses
from openproject_admin import list_roles, get_role
from openproject_admin import list_priorities, get_priority, get_default_priority
...
class TestConfig:
    ...
    def test_get_configuration(self, mock_client):
        ...
        with patch("openproject_admin.config.get_client", return_value=mock_client):
...
class TestTypes:
    ...
    def test_list_types(self, mock_client):
        ...
        with patch("openproject_admin.wp_types.get_client", return_value=mock_client):
...
class TestStatuses:
    ...
    def test_list_statuses(self, mock_client):
        ...
        with patch("openproject_admin.statuses.get_client", return_value=mock_client):
...
class TestRoles:
    ...
    def test_list_roles(self, mock_client):
        ...
        with patch("openproject_admin.roles.get_client", return_value=mock_client):
...
class TestPriorities:
    ...
    def test_list_priorities(self, mock_client):
        ...
        with patch("openproject_admin.priorities.get_client", return_value=mock_client):
