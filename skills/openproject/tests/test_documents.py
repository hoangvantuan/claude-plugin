...
from openproject_documents import get_wiki_page, list_wiki_attachments, update_wiki_page
...
class TestAttachments:
    ...
    def test_get_attachment(self, mock_client):
        ...
        with patch("openproject_documents.attachments.get_client", return_value=mock_client):
...
class TestWiki:
    ...
    def test_get_wiki_page(self, mock_client):
        ...
        with patch("openproject_documents.wiki.get_client", return_value=mock_client):
