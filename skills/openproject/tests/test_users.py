...
from openproject_users import list_groups, get_group, create_group, update_group, add_member, remove_member
from openproject_users import list_memberships, create_membership, update_membership, delete_membership
...
class TestUsers:
    ...
    def test_list_users(self, mock_client):
        ...
        with patch("openproject_users.users.get_client", return_value=mock_client):
...
class TestGroups:
    ...
    def test_list_groups(self, mock_client):
        ...
        with patch("openproject_users.groups.get_client", return_value=mock_client):
...
class TestMemberships:
    ...
    def test_list_memberships(self, mock_client):
        ...
        with patch("openproject_users.memberships.get_client", return_value=mock_client):
