...
from activities import list_activities, add_comment
from relations import list_relations, create_relation, delete_relation, RELATION_TYPES
...
class TestListWorkPackages:
    ...
    def test_list_all_work_packages(self, mock_client):
        ...
        with patch("work_packages.get_client", return_value=mock_client):
...
class TestActivities:
    ...
    def test_list_activities(self, mock_client):
        ...
        with patch("activities.get_client", return_value=mock_client):
...
class TestRelations:
    ...
    def test_list_relations(self, mock_client):
        ...
        with patch("relations.get_client", return_value=mock_client):
