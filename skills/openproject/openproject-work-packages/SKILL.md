...
- `create_work_package(project_id, subject, type_id, description, assignee_id, status_id, priority_id, parent_id, version_id, responsible_id, start_date, due_date, estimated_hours, **custom_fields)` - Create WP
- `update_work_package(id, **kwargs)` - Update WP (supports: subject, description, start_date, due_date, done_ratio, status_id, assignee_id, responsible_id, type_id, priority_id, parent_id, version_id, estimated_hours, customFieldN)
