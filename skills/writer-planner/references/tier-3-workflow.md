...
> **GUARD**: Tier đã xác định là Tier 3 từ Step 2.2. Nếu chưa → **STOP, quay lại SKILL.md Step 2.2**.
...
| EXTRACT| Key terms (~300 words) + dependencies inline                  |
...
Tier 3: inline glossary ~300 words (larger than T1 due to bigger documents).
