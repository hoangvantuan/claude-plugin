...
These examples demonstrate the desired tone, structure, and language techniques for post outlines.

## Style 1: Destruction/Rebirth
...
**Key elements**: Imperative verbs, triple repetition, elemental metaphors (fire/inferno), paradox ("hard, but simple"), mystical transformation.

## Style 2: Paradox/Identity
...
**Key elements**: Opposing pairs, absolutes, identity framing, "impossible to label", visual metaphor (tightrope).

## Style 3: Isolation/Vision
...
```
[Relatable pain point or observation]
+ [Unexpected insight or ironic contrast]
+ [Emotional validation or permission]
+ [Vague but hopeful transformation]
+ [Personal stake or haunting reflection]
= High-engagement philosophical post
```
