...
Đọc lại toàn bài, fix 3 thứ:

1. **Câu AI nhất** → viết lại, từ ngắn hơn, chi tiết cụ thể hơn, bỏ buzzword.
2. **Đoạn chỉ tóm tắt ý** → thêm insight (xem mục dưới).
3. **Mở bài**: 2 câu đầu có móc được reader không? Không → sharpen.

## Insight techniques (tối thiểu 2 insight/bài dài)

Tạo insight bằng 4 cách, KHÔNG dùng cấu trúc câu cố định:

- **Tìm mâu thuẫn** trong source hoặc quan niệm phổ biến.
- **Liên hệ ngoài ngành** (domain khác — nông nghiệp, quân sự, đời sống, thể thao).
- **Rút hệ quả** source không nói thẳng.
- **Đặt lại câu hỏi** theo góc mới.

Mỗi insight phải **earned** — build context trước, không drop in bất ngờ. Cho phép 1-2 đoạn/bài CHỈ kể mà KHÔNG rút insight (tránh preachy).
